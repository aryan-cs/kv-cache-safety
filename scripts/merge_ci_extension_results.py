...
def merge_ci_extension_results(
    *,
    ...
    manifest["combined_results"] = {
        ...
        "base_git_commit": primary_manifest.get("git_commit"),
        "base_git_dirty": primary_manifest.get("git_dirty"),
        "extension_git_commit": extension_manifest.get("git_commit"),
        "extension_git_dirty": extension_manifest.get("git_dirty"),
