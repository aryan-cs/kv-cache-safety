...
def test_h200_selectivity_launcher_commits_results_with_paper_assets() -> None:
    ...
    assert "docs/generated/selectivity_panel_phase0_ci_power.json" in launcher
...
def test_selectivity_fetcher_uses_standard_h200_env_and_verified_fetch() -> None:
    ...
    assert "docs/generated/selectivity_h200_${run_stage}_${key}" in script
    assert "docs/generated/selectivity_h200_${run_stage}_combined" in script
...
def test_selectivity_runbook_is_operator_complete() -> None:
    ...
    for text in [readme, runbook]:
        ...
        assert "docs/generated/selectivity_h200_<stage>_<model_key>" in text
