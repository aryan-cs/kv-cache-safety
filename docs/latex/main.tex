...
\begin{figure}[t]
  \centering
  \maybeincludegraphic{../generated/active_primary/figures/selective_safety_erasure_heatmap.pdf}{0.92\linewidth}{Selective Safety Erasure Index heatmap by model, suite, policy, and cache budget.}
...
\begin{figure}[t]
  \centering
  \maybeincludegraphic{../generated/active_primary/figures/prompt_effect_constellation.pdf}{0.92\linewidth}{Prompt-level baseline-to-treatment effect vectors by suite and policy.}
...
\begin{figure}[t]
  \centering
  \maybeincludegraphic{../generated/active_primary/figures/cache_state_fingerprint.pdf}{0.92\linewidth}{Token-role retention heatmap for system, user, template, and generated spans.}
...
\begin{figure}[t]
  \centering
  \maybeincludegraphic{../generated/active_primary/figures/safety_state_atlas.pdf}{0.92\linewidth}{Suite-policy atlas combining selective safety degradation with role-level cache loss.}
...
\begin{figure}[t]
  \centering
  \maybeincludegraphic{../generated/active_primary/figures/policy_uncertainty_braid.pdf}{0.92\linewidth}{Policy-level safety, capability, and selective safety erasure intervals.}
...
\begin{figure}[t]
  \centering
  \maybeincludegraphic{../generated/active_causal/figures/causal_restoration_fraction.pdf}{0.92\linewidth}{Restoration fraction by causal patch and policy-pinned condition.}
...
\begin{figure}[t]
  \centering
  \maybeincludegraphic{../generated/active_causal/figures/causal_restoration_flow.pdf}{0.92\linewidth}{Compressed, system-patched, matched-user-patched, and policy-pinned conditions.}
