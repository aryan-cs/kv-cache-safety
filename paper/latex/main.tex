...
The registered primary sweep requires public prompt-injection, harmful-request, XSTest-safe, benign-instruction, and ARC capability suites. Broader anchors such as HarmBench, IFEval, RULER, and LongBench define extension analyses only when their corresponding artifacts are present \citep{mazeika2024harmbench,chao2024jailbreakbench,rottger2023xstest,zhou2023ifeval,hsieh2024ruler,bai2024longbench}. Primary experiments target Qwen2.5 Instruct models because they are open-weight and available at 7B, 14B, and 32B scales \citep{qwen2024qwen25}.
