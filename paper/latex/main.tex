...
\begin{figure}[t]
  ...
  \caption{Prompt-level effect constellation. Each arrow starts at baseline and points toward the compressed condition in a metric-derived effect space. Coherent clusters indicate prompt families where cache interventions create similar behavioral shifts.}
