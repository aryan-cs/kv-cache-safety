...
\maybeinputtable{../audit/h200_qwen_full_sweep_summary/human_audit_summary_table.tex}{Report blinded audit label rates before making safety claims.}
\maybeinputtable{../audit/h200_qwen_full_sweep_summary/human_audit_deltas_table.tex}{Report paired baseline-versus-treatment audit deltas for unsafe compliance, refusal correctness, leakage, and benign over-refusal.}
\maybeinputtable{../audit/h200_causal_patch_qwen7b_summary/human_audit_summary_table.tex}{Report blinded causal-diagnostic audit label rates before making restoration claims.}
\maybeinputtable{../audit/h200_causal_patch_qwen7b_summary/human_audit_deltas_table.tex}{Report paired causal-diagnostic audit deltas for system-role patching, matched non-policy patching, and policy-pinned mitigation.}
