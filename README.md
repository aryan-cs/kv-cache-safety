...
> Inference-time KV-cache optimizations can selectively weaken safety/refusal behavior while preserving ordinary model capability, because safety behavior depends on fragile cache-resident routing state.
