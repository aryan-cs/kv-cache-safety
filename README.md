...
Tiny-model runs are also plumbing checks only. The readiness script rejects mock, tiny, dirty, and smoke runs by default unless explicit override flags are passed.
