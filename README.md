...
Tiny-model runs are also plumbing checks only. The readiness script rejects mock, tiny, dirty, smoke, incomplete generation matrices, and missing prompt provenance by default unless explicit override flags are passed.
